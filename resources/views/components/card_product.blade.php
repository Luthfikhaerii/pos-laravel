<div class="bg-white shadow-sm w-72 h-80 rounded-lg m-4">
    ...
    <img src="{{ asset('/storage/'.$image) }}" alt="image" class="w-64 h-48 m-auto pt-5 rounded-lg"/>
    ...
    <div class="flex justify-between px-4 pt-2">
        ...
        <a href="{{ url('/delete_product/'.$deleteUrl) }}" class="w-24 h-8 bg-red-500 rounded-lg flex items-center justify-center text-white font-semibold" onclick="alert('delete product!')">Delete</a>
    </div>
</div>