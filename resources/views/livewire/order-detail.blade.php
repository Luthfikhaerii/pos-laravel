...
<div class="bg-white shadow-xl w-64 h-[90vh] fixed right-3 top-6 flex flex-col border border-gray-200 rounded-md z-20">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-500 p-3 shadow-md rounded-t-md">
        <div class="flex items-center justify-between">
            ...
            <span
                class="text-[10px] bg-white/20 backdrop-blur px-2 py-0.5 rounded-sm 
        ...
        @if (isset($detail))
            ...
            <div class="space-y-3">
                @foreach ($detail['transaction_item'] as $item)
                    <div
                        class="bg-white border border-gray-200 rounded-md p-3 text-xs flex justify-between items-start">
    ...
    <div class="border-t border-gray-200 bg-white p-3 rounded-b-md">
        ...
        <select wire:change="updateStatus({{ $detail['id'] }}, $event.target.value)"
